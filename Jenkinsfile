        ...
        stages {
                ...
                stage('Build-nonmaster') {
                        ...
                        steps { 
                                ...
                                sh "docker pull quay.io/encode-dcc/chip-seq-pipeline:v2"
                                sh "docker login -u=${QUAY_USER} -p=${QUAY_PASS} quay.io"
                                sh "docker build --cache-from quay.io/encode-dcc/chip-seq-pipeline:v2 -f docker_image/Dockerfile -t chip-seq-pipeline ."
